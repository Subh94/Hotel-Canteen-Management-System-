...
<html lang="en">
  <head>
    ...
    <title>Hotel Grand: Access denied</title>
...
<div class="error">Access Denied!</div>
  <p>You don't have access to this page. <a href="login-register.php">Click Here</a> to login first or register for free. The registration won't take long time</p>
  </div>
</div>
</div>
</div>
